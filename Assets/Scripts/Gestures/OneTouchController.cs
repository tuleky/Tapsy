...
public class OneTouchController : MonoBehaviour, IGestures
{
    ...
    {
        if (Input.touchCount > 2 && !GameManager.Instance.isPressed && GameManager.Instance.difficulty == 1) // If its in hard mode
        {
